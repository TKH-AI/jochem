...
train_file_paths = {
    '2': '/home/jheerebrugh/thesis-code-methods/resources_linkedin_1/distill/train_2.csv',
    '5': '/home/jheerebrugh/thesis-code-methods/resources_linkedin_1/distill/train_5.csv', 
    '7': '/home/jheerebrugh/thesis-code-methods/resources_linkedin_1/distill/train_7.csv',
    '10': '/home/jheerebrugh/thesis-code-methods/resources_linkedin_1/distill/train_10.csv',
    '12': '/home/jheerebrugh/thesis-code-methods/resources_linkedin_1/distill/train_12.csv',
    '25': '/home/jheerebrugh/thesis-code-methods/resources_linkedin_1/distill/train_25.csv',
    '50': '/home/jheerebrugh/thesis-code-methods/resources_linkedin_1/distill/train_50.csv',
    '75': '/home/jheerebrugh/thesis-code-methods/resources_linkedin_1/distill/train_75.csv',
    '100': '/home/jheerebrugh/thesis-code-methods/resources_linkedin_1/distill/train_100.csv',
}

# Load the validation dataset
validation_file_path = '/home/jheerebrugh/thesis-code-methods/resources_linkedin_1/validation_dataset.csv'
...
CONFIG_DIR = "/home/jheerebrugh/thesis-code-methods/results_linkedin/distill/1.0-0.4"
...
def train_model_on_subset(subset_name):
    ...
    # loss_logger.plot_losses('/home/jheerebrugh/thesis-code-methods/plots_linkedin/distill', run_name=f'run_{subset_name}', num_epochs=50, alpha=alpha, beta=beta)

# Train on different percentages of the training set
for subset_name in ['2', '5', '7', '10', '12']:
