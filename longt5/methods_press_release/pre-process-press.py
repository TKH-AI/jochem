...
file_path = '/Users/jochem/Desktop/thesis-code-methods/resources_press_release/final_press_release_clean_llama.csv'
df = pd.read_csv(file_path)

# Vanilla dataset preparation
df_vanilla = df[['datasheet_description', 'Press_Release']]
...
df_distill = df[['datasheet_description', 'Press_Release', 'Rationale']]
...
output_dir = '/Users/jochem/Desktop/thesis-code-methods/resources_press_release_4/'
