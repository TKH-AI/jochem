...
train_file_paths = {
    '2': '/projects/0/prjs1229/resources_press_release_4/distill/train_2.csv',
    '5': '/projects/0/prjs1229/resources_press_release_4/distill/train_5.csv', 
    '7': '/projects/0/prjs1229/resources_press_release_4/distill/train_7.csv',
    '10': '/projects/0/prjs1229/resources_press_release_4/distill/train_10.csv',
    '12': '/projects/0/prjs1229/resources_press_release_4/distill/train_12.csv',
    '25': '/projects/0/prjs1229/resources_press_release_4/distill/train_25.csv',
    '50': '/projects/0/prjs1229/resources_press_release_4/distill/train_50.csv',
    '75': '/projects/0/prjs1229/resources_press_release_4/distill/train_75.csv',
    '100': '/projects/0/prjs1229/resources_press_release_4/distill/train_100.csv',
}

# Load the validation dataset
validation_file_path = '/projects/0/prjs1229/resources_press_release_4/validation_dataset.csv'
...
def tokenize_function(examples: Dict[str, List[Any]], tokenizer):
    ...
    marketing_prompts = [
        f"Generate a press release for the following datasheet description: {inp} Press Release: {marketing_copy}"
        for inp, marketing_copy in zip(examples["input"], examples["label"])
    ]
    
    rationale_prompts = [
        f"Generate a rationale behind writing a press release for the following datasheet description: {inp} Rationale: {rationale}"
    ...
    for i in range(len(marketing_prompts)):
        ...
        marketing_input = f"Generate a press release for the following datasheet description: {examples['input'][i]} Marketing Post:"
        ...
        rationale_input = f"Generate a rationale behind writing a press release for the following datasheet description: {examples['input'][i]} Rationale:"
...
CONFIG_DIR = "/projects/0/prjs1229/results_llama/distill/press_release/fourth_run"
...
def get_training_parameters(subset_size):
    ...
    parameter_mapping = {
        '2': (10, 400, 5),     # Smallest dataset: log very frequently
        '5': (15, 500, 5),
        '7': (20, 600, 8),
        '10': (30, 800, 10),
        '12': (40, 900, 10),
        '25': (50, 1200, 15),
        '50': (60, 1800, 20),  # Larger dataset: log less frequently
...
def train_model_on_subset(subset_name):
    ...
    loss_logger.plot_losses(
        "/projects/0/prjs1229/plots_llama/distill/press_release/fourth_run",
