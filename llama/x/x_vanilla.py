...
train_file_paths = {
    '2': '/projects/0/prjs1229/resources_x_4/vanilla/train_2.csv',
    '5': '/projects/0/prjs1229/resources_x_4/vanilla/train_5.csv',
    '7': '/projects/0/prjs1229/resources_x_4/vanilla/train_7.csv',
    '10': '/projects/0/prjs1229/resources_x_4/vanilla/train_10.csv',
    '12': '/projects/0/prjs1229/resources_x_4/vanilla/train_12.csv',
    '25': '/projects/0/prjs1229/resources_x_4/vanilla/train_25.csv',
    '50': '/projects/0/prjs1229/resources_x_4/vanilla/train_50.csv',
    '75': '/projects/0/prjs1229/resources_x_4/vanilla/train_75.csv',
    '100': '/projects/0/prjs1229/resources_x_4/vanilla/train_100.csv',
}
...
def tokenize_function(examples: Dict[str, List[Any]], tokenizer):
    ...
    for i in range(len(prompts)):
        # Mask input portion
        input_portion = f"Generate a marketing post on the platform X for the following datasheet description: {examples['input'][i]} Marketing Post:"
...
CONFIG_DIR = "/projects/0/prjs1229/results_llama/vanilla/x/fourth_run"
...
def train_model_on_subset(subset_name):
    ...
    loss_logger.plot_losses(
        "/projects/0/prjs1229/plots_llama/vanilla/x/fourth_run",
