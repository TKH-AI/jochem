...
train_file_paths = {
    '2': '/projects/0/prjs1229/resources_linkedin_4/distill/train_2.csv',
    '5': '/projects/0/prjs1229/resources_linkedin_4/distill/train_5.csv', 
    '7': '/projects/0/prjs1229/resources_linkedin_4/distill/train_7.csv',
    '10': '/projects/0/prjs1229/resources_linkedin_4/distill/train_10.csv',
    '12': '/projects/0/prjs1229/resources_linkedin_4/distill/train_12.csv',
    '25': '/projects/0/prjs1229/resources_linkedin_4/distill/train_25.csv',
    '50': '/projects/0/prjs1229/resources_linkedin_4/distill/train_50.csv',
    '75': '/projects/0/prjs1229/resources_linkedin_4/distill/train_75.csv',
    '100': '/projects/0/prjs1229/resources_linkedin_4/distill/train_100.csv',
}
...
def tokenize_function(examples: Dict[str, List[Any]], tokenizer):
    ...
    rationale_prompts = [
        f"Generate a rationale behind writing a marketing post on the platform LinkedIn for the following datasheet description: {inp} Rationale: {rationale}"
    ...
    for i in range(len(marketing_prompts)):
        ...
        marketing_input = f"Generate a marketing post on the platform LinkedIn for the following datasheet description: {examples['input'][i]} Marketing Post:"
        ...
        rationale_input = f"Generate a rationale behind writing a marketing post on the platform LinkedIn for the following datasheet description: {examples['input'][i]} Rationale:"
...
CONFIG_DIR = "/projects/0/prjs1229/results_llama/distill/linkedin/fourth_run"
...
def train_model_on_subset(subset_name):
    ...
    loss_logger.plot_losses(
        "/projects/0/prjs1229/plots_llama/distill/linkedin/fourth_run",
