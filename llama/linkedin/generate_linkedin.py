...
TEST_FILE = '/projects/0/prjs1229/resources_linkedin_4/test_dataset.csv'
MAX_NEW_TOKENS = 512
...
def get_model_paths():
    ...
    for subset in SUBSETS:
        distill_paths[subset] = find_checkpoint_dir(f"/projects/0/prjs1229/results_llama/distill/linkedin/fourth_run/run_{subset}")
        vanilla_paths[subset] = find_checkpoint_dir(f"/projects/0/prjs1229/results_llama/vanilla/linkedin/fourth_run/run_{subset}")
...
def main():
    ...
    prompts = [
        f"Generate a marketing post on the platform LinkedIn for the following datasheet description: {input_text} Marketing Post:"
    ...
    output_dir = '/projects/0/prjs1229/results_llama/generated_answers/linkedin'
